...
| `course/` | 코스 탭 전용 컴포넌트 (`course-screen.tsx` = `/course`, Upcoming/History 세그먼트 탭 + 탭별 코스 카드 리스트/공유 빈 상태 + FAB; `course-detail-screen.tsx` = `/course/[id]`, 뒤로가기 헤더 + 스팟 타임라인) |
