...
export function BottomSheet({ id, title, children }: BottomSheetProps) {
  return (
    <div
      id={id}
      popover="auto"
      className="fixed inset-x-0 top-auto bottom-0 m-0 w-full flex-col gap-3 rounded-t-[30px] border-0 bg-white p-0 pt-5 [&::backdrop]:bg-black/30 [&:popover-open]:flex"
    >
